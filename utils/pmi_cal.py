...
def get_pmi_dict(data):
    ...
    try:
        ...
        with open(f'{FILE_LOCATION}/dummy_pmi.pkl', 'rb') as file:
        ...
        PMF_dict, alphabet_dict = get_cmf_pmf_dict_with_alphabet(data=original_data, is_pmf=True)
        PMI_dict = pointwise_mutual_information(PMF_dict=PMF_dict, COLUMNS=COLUMNS, alphabet_dict=alphabet_dict)
        
        with open(f'{FILE_LOCATION}/dummy_pmi.pkl', 'wb') as file:
